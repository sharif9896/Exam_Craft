...
//   // ✅ SECTION CONFIG
//   const sectionMeta = {
//     "Part-A": { heading: "Answer All the Questions", marks: "(10X1=10)" },
//     "Part-B": { heading: "Answer All the Questions", marks: "(5X2=10)" },
//     "Part-C": { heading: "Answer All the Questions", marks: "(5X5=25)" },
//     "Part-D": { heading: "Answer ANY THREE Questions", marks: "(10X1=10)" },
//   };
...
//     exec(index, "insertHTML", `<img src="${res.data.url}" style="max-width:100%" />`);
//   };

//   const handleOptionChange = (index, option, value) => {
//     setMcqOptions((prev) => ({
//       ...prev,
//       [index]: { ...prev[index], [option]: value },
//     }));
//   };

//   // ✅ GENERATE QUESTIONS + HEADER DATA
...
//     await axios.post("http://localhost:3095/save", buildPayload("published"));
//     alert("Published");
//   };

//   const saveDraft = async () => {
//     await axios.post("http://localhost:3095/save", buildPayload("draft"));
//     alert("Draft saved");
//   };
...
//             <div className="bg-gray-200 p-4 flex justify-between font-bold">
//               {sectionMeta[section]?.heading}
//               <span>{sectionMeta[section]?.marks}</span>
//             </div>
...
//           <button onClick={saveContent} className="bg-blue-600 text-white px-6 py-2 rounded">
//             Publish
//           </button>
//           <button onClick={saveDraft} className="bg-gray-600 text-white px-6 py-2 rounded">
//             Save Draft
//           </button>
//           {saving && <p>Auto saving...</p>}
//         </div>
//       </div>
//     </DashboardLayout_2>
//   );
...
// //   // GENERATE QUESTIONS
// //   const generatePaper = async () => {
// //     const res = await axios.get(`http://localhost:3095/api/papers/latest:${staffId}`);
// //     const paper = Array.isArray(res.data) ? res.data[0] : res.data;
